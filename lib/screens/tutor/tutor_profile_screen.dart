...
import 'package:accomy/screens/login_screen.dart'; // Assuming this is the correct path
...
class _TutorProfileScreenState extends State<TutorProfileScreen> {
  ...
  // Controllers and keys for the change password dialog
  ...
  /// 1. Method to show the attractively designed change password dialog
  Future<void> _showChangePasswordDialog(BuildContext context) async {
    ...
    return showDialog(
      context: context,
      builder: (context) {
        // StatefulBuilder manages the local state of the dialog (for password visibility)
  ...
  /// Helper method to style the text fields in the dialog
  ...
  /// 2. Core logic for changing the password with Firebase
  Future<void> _changePassword() async {
    ...
    try {
      ...
      Navigator.of(context).pop(); // Dismiss the change password dialog
  ...
  Widget build(BuildContext context) {
    ...
    final staffRef =
        FirebaseFirestore.instance.collection('staff').doc(_currentUser!.uid);
      ...
      children: [
        ...
        SizedBox(
          ...
          child: OutlinedButton.icon(
            ...
            // 3. Connect the button to the dialog function
